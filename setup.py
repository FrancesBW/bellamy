...
setup(
    ...
    packages=['functions'],
    data_files=[('', ['functions/default_data/GLEAM.txt','functions/default_data/TGSS.txt','functions/default_data/target_format_default.txt','format_templates/reference_catalogue_format','format_templates/target_catalogue_format'])],
