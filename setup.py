...
setup(
    ...
    packages=['functions'],
    data_files=[('maccas_catalog_formats', ['functions/default_data/GLEAM.txt','functions/default_data/TGSS.txt','functions/default_data/target_format_default.txt','format_templates/reference_catalogue_format.txt','format_templates/target_catalogue_format.txt'])],
