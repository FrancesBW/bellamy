...
def run(raw_target_table, raw_reference_table, snr_restrict,log,options):
		...
		print("Minimum accepted combined probability: ",np.nanmin(cross_match_table['norm_prob']))
		print('Minimum accepted raw probability: ',np.nanmin(cross_match_table[np.where(cross_match_table['num_of_candidates']==1)]['raw_prob']))
